...
map.on('mousemove', function (e) {
    ...
    var features = map.queryRenderedFeatures(e.point, {
        layers: ['bnrc-public-access', 'bnrc-maintained', 'mahanna-trails', 'yokun-north', 'yokun-south', 'yokun-ridge', 'old-mill', 'olivias-group', 'burbank-trail', 'steepletop-trail', 'clam-river', 'housatonic-flats', 'hoosac-range', 'constitution-hill', 'bobs-way', 'hollow-fields', 'basin-pond', 'alford-springs']
    });
